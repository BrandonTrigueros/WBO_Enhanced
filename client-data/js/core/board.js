...
/**
 * board.js — Bootstrap
 * Creates the global Tools facade and loads i18n + server config.
 * Sub-modules (canvasState, socketManager, drawingEngine, toolRegistry,
 * uiController) attach their members to Tools during script load.
 */
